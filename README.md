...
Run `innit_database.sql` to set up the database structure and schemas.

### 3. Pipeline Execution

1. **Bronze** — Ingest raw data using scripts in `scripts/bronze/`
...
2. **Silver** — Perform cleaning using `scripts/silver/`

3. **Gold** — Create business views using `scripts/gold/`
...
> **Note:** This project was developed as part of a learning journey following the *"Data with Baraa SQL Mastery Course"*, featuring advanced testing and custom visualizations not included in the original curriculum.
