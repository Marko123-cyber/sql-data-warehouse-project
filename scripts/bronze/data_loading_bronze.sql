...
BEGIN
    BEGIN TRY
        ...
        FROM '/var/opt/mssql/data/dwh_project/datasets/crm_source/cust_info.csv'
        WITH (
            FIRSTROW=2,
            FIELDTERMINATOR = ',', 
            TABLOCK
        ...
        FROM '/var/opt/mssql/data/dwh_project/datasets/crm_source/prd_info.csv'
        WITH (
            FIRSTROW=2,
            FIELDTERMINATOR = ',', 
            TABLOCK
        ...
        FROM '/var/opt/mssql/data/dwh_project/datasets/crm_source/sales_details.csv'
        WITH (
            FIRSTROW=2,
            FIELDTERMINATOR = ',', 
            TABLOCK
        ...
        FROM '/var/opt/mssql/data/dwh_project/datasets/erp_source/CUST_AZ12.csv'
        WITH (
            FIRSTROW=2,
            FIELDTERMINATOR = ',', 
            TABLOCK
        ...
        FROM '/var/opt/mssql/data/dwh_project/datasets/erp_source/LOC_A101.csv'
        WITH (
            FIRSTROW=2,
            FIELDTERMINATOR = ',', 
            TABLOCK
        ...
        FROM '/var/opt/mssql/data/dwh_project/datasets/erp_source/PX_CAT_G1V2.csv'
        WITH (
            FIRSTROW=2,
            FIELDTERMINATOR = ',', 
            TABLOCK
